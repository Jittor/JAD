...
model = dict(
    ...
    motion_head=dict(
        ...
        anchor_info_path='adzoo/uniad/data/others/motion_anchor_infos_mode6.pkl',
        transformerlayers=dict(
...
data_root = "adzoo/uniad/data/nuscenes/"
info_root = "adzoo/uniad/data/infos/"
...
load_from = "adzoo/uniad/ckpts/uniad_base_e2e.pth"
