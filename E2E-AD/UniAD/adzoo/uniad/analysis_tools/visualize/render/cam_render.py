    ...
    def project_to_cam(self,
        ...
        for agent in agent_prediction_list:
            ...
            if project_traj:
                ...
                box.pred_traj = (Quaternion(
                    lidar_cs_record['rotation']).rotation_matrix @ box.pred_traj.transpose()).transpose()
        ...
        for i, box in enumerate(boxes):
            ...
            if project_traj:
                ...
                box.pred_traj = (Quaternion(
                    cs_record['rotation']).inverse.rotation_matrix @ box.pred_traj.transpose()).transpose()
        ...
        for i, cam in enumerate(self.cams):
            ...
            for j, box in enumerate(box_list):
                ...
                traj_points = view_points(
                    total_xy.transpose(), camera_intrinsic, normalize=True)[:2, :]
