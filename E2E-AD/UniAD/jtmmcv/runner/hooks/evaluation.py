...
import jittor as jt
from jittor.dataset import Dataset #此loader非彼loader


from jtmmcv.fileio.file_client import FileClient
from jtmmcv.utils import is_seq_of
...
class EvalHook(Hook):
    ...
    Args:
        dataloader (DataLoader): A jittor dataloader, whose dataset has
    ...
    def __init__(self,
        ...
        if not isinstance(dataloader, Dataset):
            raise TypeError(f'dataloader must be a jittor Dataset, '
...
class DistEvalHook(EvalHook):
    ...
    def _do_evaluate(self, runner):
        ...
        # and running_var) is not supported in the DDP of jittor,
        ...
        if self.broadcast_bn_buffer:
            ...
            for name, module in model.named_modules():
                if isinstance(module,
                              BatchNorm) and module.track_running_stats:
                    jt.mpi.mpi_broadcast(module.running_var, root=0)
                    jt.mpi.mpi_broadcast(module.running_mean, root=0)
