...
//   const int &nheads, const int &channels, const float &h,
//   const float &w, const int &m, const int &c) {
...
//   const int n, const float *data_value, const long long *data_spatial_shapes,
//   const long long *data_level_start_index, const float *data_sampling_loc,
//   const float *data_attn_weight, const int batch_size,
...
//     auto *data_col_ptr = data_col + index;
...
//         const auto loc_w = data_sampling_loc[data_loc_w_ptr];
//         const auto loc_h = data_sampling_loc[data_loc_w_ptr + 1];
//         const auto weight = data_attn_weight[data_weight_ptr];
...
// void ms_deformable_im2col_cuda(const float *data_value,
//                               const long long *data_spatial_shapes,
//                               const long long *data_level_start_index,
...
//                               const int num_point, float *data_col) {
  ...
  if (channels > 1024) {
    if ((channels & 1023) == 0) {
      ...
      ms_deformable_col2im_gpu_kernel_gm<scalar_t>
          <<<GET_BLOCKS(num_actual_kernels, num_threads), num_threads, 0>>>(num_kernels, grad_col, data_value, data_spatial_shapes,
