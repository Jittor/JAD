...
from jtmmcv.core.visualizer import show_multi_modality_result


# from jtmmcv.core import (CameraInstance3DBoxes, bbox3d2result,
#                           show_multi_modality_result)
from jtmmcv.models.builder import DETECTORS
from jtmmcv.models.detectors.single_stage import SingleStageDetector
...
class SingleStageMono3DDetector(SingleStageDetector):
    ...
    def simple_test(self, img, img_metas, rescale=False):
        ...
        Args:
            imgs (list[jittor.Var]): List of multiple images
        ...
        if self.bbox_head.pred_bbox2d:
            from jtmmcv.core import bbox2result
            bbox2d_img = [
    ...
    def aug_test(self, imgs, img_metas, rescale=False):
        ...
        for i in range(len(outs_list[0])):  # for each prediction
            ...
            for j in range(len(outs_list[0][i])):
                ...
                avg_feats = jittor.mean(
                    jittor.concat([x[i][j] for x in outs_list]),
                    dim=0,
                    keepdims=True)
