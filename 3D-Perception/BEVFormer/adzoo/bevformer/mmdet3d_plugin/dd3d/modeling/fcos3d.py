...
class FCOS3DLoss(nn.Module):
    ...
    def forward(
        ...
        canon_box_sizes = box3d_quat_pred.new(self.canon_box_sizes)[labels[pos_inds]]
...
class FCOS3DInference():
    ...
    def forward_for_single_feature_map(
        ...
        for i in range(N):
            ...
            canon_box_sizes = box3d_quat.new(self.canon_box_sizes)[pred_instances[i].pred_classes]
