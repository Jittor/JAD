...
from jtmmcv.core.bbox.transforms import bbox2result
...
class SingleStageDetector(BaseDetector):
    ...
    def simple_test(self, img, img_metas, rescale=False):
        ...
        Args:
            img (jittor.Var): Images with shape (N, C, H, W).
    ...
    #     # get shape as tensor
    #     img_shape = jittor._shape_as_tensor(img)[2:]
...
class SingleStage3DDetector(Base3DDetector):
    ...
    def extract_feat(self, points, img_metas=None):
        ...
        Args:
            points (jittor.Var): Input points.
        """
