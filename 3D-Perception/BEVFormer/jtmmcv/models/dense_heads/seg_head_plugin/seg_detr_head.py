...
from jtmmcv.models.dense_heads.anchor_free_head import AnchorFreeHead
...
class SegDETRHead(
    ...
    def __init__(
        ...
        if class_weight is not None and (self.__class__ is SegDETRHead):
            ...
            class_weight = jittor.ones(num_things_classes + 1) * class_weight
    ...
    def forward_single(self, x, img_metas):
        ...
        masks = jnn.interpolate(masks.unsqueeze(1),
                              size=x.shape[-2:]).to(bool).squeeze(1)
        # position encoding
    ...
    def loss_single(self,
        ...
        num_total_pos = jittor.clamp(reduce_mean(num_total_pos), min_v=1).data.tolist()
    ...
    def _get_bboxes_single(self,
        ...
        if self.loss_cls.use_sigmoid:
            ...
            scores, det_labels = jnn.softmax(cls_score, dim=-1)[..., :-1].max(-1)
