...
from jtmmcv.core.bbox.transforms import bbox_mapping_back
from jtmmcv.core.post_processing.merge_augs import merge_aug_proposals
...
class BBoxTestMixin(object):
    ...
    def aug_test_bboxes(self, feats, img_metas, rescale=False):
        ...
        merged_factors = jittor.concat(aug_factors, dim=0) if aug_factors else None
    ...
    def merge_aug_bboxes(self, aug_bboxes, aug_scores, img_metas):
        ...
        bboxes = jittor.concat(recovered_bboxes, dim=0)
        if aug_scores is None:
            return bboxes
        else:
            scores = jittor.concat(aug_scores, dim=0)
