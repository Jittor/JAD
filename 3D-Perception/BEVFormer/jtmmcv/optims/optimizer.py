import jittor
import warnings
from jittor.nn import GroupNorm, LayerNorm, BatchNorm, InstanceNorm
from jtmmcv.utils import build_from_cfg, is_list_of, Registry

from jtmmcv.utils.ext_loader import check_ops_exist
from jtmmcv.utils import Registry
import inspect
import copy
...
class DefaultOptimizerConstructor:
    ...
    Example 1:
        >>> model = jittor.nn.modules.Conv1d(1, 1, 1)
    ...
    def add_params(self, params, module, prefix='', is_dcn_module=None):
        ...
        Args:
            params (list[dict]): A list of param groups, it will be modified
                in place.
            module (Module): The module to be added.
        ...
        is_dwconv = (
            isinstance(module, jittor.nn.Conv2d)
        ...
        for name, param in module.named_parameters(recurse=False):
            ...
            if not is_custom:
                ...
                if (prefix.find('conv_offset') != -1 and is_dcn_module
                        and isinstance(module, jittor.jnn.Conv2d)):
            ...
            from jtmmcv.ops.deform_conv2 import DeformConv
            # TODO: OPS
