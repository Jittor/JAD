...
class LoggerHook(Hook):
    ...
    @staticmethod
    def is_scalar(val, include_np=True, include_jittor=True):
        """Tell the input variable is a scalar or not.

        Args:
            val: Input variable.
            include_np (bool): Whether include 0-d np.ndarray as a scalar.
            include_jittor (bool): Whether include 0-d jittor.Var as a scalar.
        ...
        if isinstance(val, numbers.Number):
            ...
            return True
        elif include_jittor and isinstance(val, jittor.Var) and len(val) == 1:
            return True
        else:
            return False
