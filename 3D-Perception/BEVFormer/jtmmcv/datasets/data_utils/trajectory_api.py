...
class NuScenesTraj(object):
    ...
    def prepare_sdc_vel_info(self):
        ...
        for scene in self.nusc.scene:
            ...
            while sample['token'] != last_sample_token:
                ...
                vel = vel @ np.linalg.inv(e2g_r_mat).transpose() @ np.linalg.inv(
                    l2e_r_mat).transpose()
                vel = vel[:2]
    ...
    def get_sdc_planning_label(self, sample_token):
        ...
        for _ in range(self.planning_steps):
            ...
            next_bbox3d.rotate(l2e_r_mat_curr.transpose())
            next_bbox3d.translate(l2e_t_curr)


            # to bbox under world frame
            next_bbox3d.rotate(e2g_r_mat_curr.transpose())
            ...
            next_bbox3d.rotate(m1.transpose())
            ...
            next_bbox3d.rotate(m2.transpose())
