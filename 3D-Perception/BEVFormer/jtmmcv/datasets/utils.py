...
from jtmmcv.models import VGG
from pyquaternion import Quaternion
from jtmmcv.runner.hooks import HOOKS, Hook

from jtmmcv.datasets.pipelines import (Collect3D, DefaultFormatBundle3D,
                                        LoadAnnotations3D,
...
from jtmmcv.datasets.pipelines import LoadAnnotations, LoadImageFromFile
from jtmmcv.models.dense_heads import GARPNHead, RPNHead
from jtmmcv.models.roi_heads.mask_heads import FusedSemanticHead
...
def extract_result_dict(results, key):
    ...
    Returns:
        np.ndarray | jittor.Var | None: Data term.
    """
