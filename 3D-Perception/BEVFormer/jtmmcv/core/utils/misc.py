...
def mask2ndarray(mask):
    ...
    Args:
        ...
        jittor.Var or np.ndarray): The mask to be converted.
    ...
    elif isinstance(mask, jittor.Var):
...
def flip_tensor(src_tensor, flip_direction):
    ...
    if flip_direction == 'horizontal':
        out_tensor = jittor.flip(src_tensor, [3])
    elif flip_direction == 'vertical':
        out_tensor = jittor.flip(src_tensor, [2])
    else:
        out_tensor = jittor.flip(src_tensor, [2, 3])
    return out_tensor
