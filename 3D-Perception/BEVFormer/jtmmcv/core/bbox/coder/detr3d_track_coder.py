...
from jtmmcv.core.bbox.coder.base_bbox_coder import BaseBBoxCoder
from jtmmcv.core.bbox.builder import BBOX_CODERS
from ..util import denormalize_bbox
from ..structures.utils import xywhr2xyxyr
from jtmmcv.ops.iou3d import nms_bev  
...
class DETRTrack3DCoder(BaseBBoxCoder):
    ...
    def decode_single(self, cls_scores, bbox_preds, 
        ...
        indexs, _ = cls_scores.argmax(dim=-1)
        ...
        if self.post_center_range is not None:
            self.post_center_range = jittor.array(
