...
import numpy as np
import jittor
from jtmmcv.utils import print_log
...
def eval_det_cls(pred, gt, iou_thr=None):
    ...
    for img_id in gt.keys():
        ...
        if cur_gt_num != 0:
            gt_cur = jittor.zeros([cur_gt_num, 7], dtype=jittor.float32)
    ...
    for img_id in pred.keys():
        ...
        if cur_num == 0:
            continue
        pred_cur = jittor.zeros((cur_num, 7), dtype=jittor.float32)
        box_idx = 0
...
def indoor_eval(gt_annos,
    ...
    Args:
        ...
        dt_annos (list[dict]): Detection annotations. the dict
            ...
            - labels_3d (jittor.Var): Labels of boxes.
            - boxes_3d (:obj:`BaseInstance3DBoxes`): \
                3D bounding boxes in Depth coordinate.
            - scores_3d (jittor.Var): Scores of boxes.
